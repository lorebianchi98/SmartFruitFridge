...
#define SENSOR_TYPE "ethylene_sensor"
...
PROCESS(ethylene_server, "Server for ethylene sensor");
AUTOSTART_PROCESSES(&ethylene_server);
...
extern coap_resource_t ethylene_sensor; 
...
PROCESS_THREAD(ethylene_server, ev, data)
{
  ...
  LOG_INFO("Starting ethylene Server\n");

  coap_activate_resource(&ethylene_sensor, "ethylene_sensor");
